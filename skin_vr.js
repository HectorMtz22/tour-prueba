...
function pano2vrVrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		texture = loader.load('data:image/png;base64,'+
	'xqiAmqoKaYoAhqjAlqoOaYoATaABNUQJtgggJoI0yoBm2GCZWgDTGhcgTyM0hrhQkaM6U2mACLsp1vuPt7PPvU5/FsSimllFJKKaWUUkoppZRSw74BFKz9mmr0ppwAAAAASUVORK5CYII=');
		...
		loader = new THREE.TextureLoader();
		texture = loader.load('data:image/png;base64,'+
	'oBCjaoPqBggeoFCvKofqAgjeoJCrKovqAgieoNCnKo/jelzbDnxJrfc8rycgAsyR8UbqGW1QMUzqhzHhh5Y85j9ZyUUkoppZRSSimllFJKKaVG/QDj6/ySCZmKOwAAAABJRU5ErkJggg==');
		texture.colorSpace = player.getVRTextureColorSpace();
		material = new THREE.MeshBasicMaterial( {map: texture, side: THREE.DoubleSide, transparent: true} );
		...
		loader = new THREE.TextureLoader();
		texture = loader.load('data:image/png;base64,'+
	''+
	''+
	''+
	'');
		texture.colorSpace = player.getVRTextureColorSpace();
		material = new THREE.MeshBasicMaterial( {map: texture, side: THREE.DoubleSide, transparent: true} );
		...
		loader = new THREE.TextureLoader();
		texture = loader.load('data:image/png;base64,'+
	'');
		texture.colorSpace = player.getVRTextureColorSpace();
		material = new THREE.MeshBasicMaterial( {map: texture, side: THREE.DoubleSide, transparent: true} );
		...
		loader = new THREE.TextureLoader();
		texture = loader.load('data:image/png;base64,'+
	''+
	'TnOWR6XmMHMGmCJdc5o13UunuC3gYkhxocwZXLUFEsaBZ4XeNs4dWowT2ervhm6amafvudTIjwuAFYxaT96BAc7YCi3Gce4A7ULkGQnjRNb83dA/0U/lX/X4p7KIiIiIiIiIiIiIiIiIiIiIiIiIiIiIiIiI/O9+AMqY61uB/8gcAAAAAElFTkSuQmCC');
		texture.colorSpace = player.getVRTextureColorSpace();
		material = new THREE.MeshBasicMaterial( {map: texture, side: THREE.DoubleSide, transparent: true} );
	...
	function SkinCloner_node_cloner_vr_Class(nodeId, parentScope, ggParent, parameter) {
		...
		el.userData.textColor = new THREE.Color(0, 0.666667, 1).convertSRGBToLinear();
	...
	function SkinHotspotClass_ht_video_url(parentScope,hotspot) {
		...
		loader = new THREE.TextureLoader();
		texture = loader.load('data:image/png;base64,'+
	''+
	'');
		texture.colorSpace = player.getVRTextureColorSpace();
		material = new THREE.MeshBasicMaterial( {map: texture, side: THREE.DoubleSide, transparent: true} );
	...
	'AAAABJRU5ErkJggg==');
		...
		textureOver = loader.load('data:image/png;base64,'+
	'e3MZeI7bRPLhE9XoHcSAfwr1wAmwkBbGcFsKEawJZ+AIdKARxrBnCwHsCjHQE8XBTA420BBrcXz/uApUO8gXPJDegU76zznPICnr8ncrny/HhntxGrPrKe1O9zJuIUT2qbr9dfwbD1gl/1AgAAAAAAAABgjG9BQo5NO0fQxAAAAABJRU5ErkJggg==');
	...
	function SkinHotspotClass_ht_info(parentScope,hotspot) {
		...
		loader = new THREE.TextureLoader();
		texture = loader.load('data:image/png;base64,'+
	''+
	''+
	''+
	''+
	'');
		texture.colorSpace = player.getVRTextureColorSpace();
		material = new THREE.MeshBasicMaterial( {map: texture, side: THREE.DoubleSide, transparent: true} );
	...
	function SkinHotspotClass_ht_image(parentScope,hotspot) {
		...
		loader = new THREE.TextureLoader();
		texture = loader.load('data:image/png;base64,'+
	''+
	''+
	''+
	'');
		texture.colorSpace = player.getVRTextureColorSpace();
		material = new THREE.MeshBasicMaterial( {map: texture, side: THREE.DoubleSide, transparent: true} );
	...
	function SkinHotspotClass_ht_node(parentScope,hotspot) {
		...
		loader = new THREE.TextureLoader();
		texture = loader.load('data:image/png;base64,'+
	''+
	''+
	''+
	''+
	''+
	''+
	''+
	'');
		texture.colorSpace = player.getVRTextureColorSpace();
		material = new THREE.MeshBasicMaterial( {map: texture, side: THREE.DoubleSide, transparent: true} );
